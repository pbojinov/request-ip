...
test('ip returns false for non-IP values', (t) => {
    ...
    t.notOk(
        is.ip('test:test:test:test:test:test:test:test'),
        '"test:test:test:test:test:test:test:test" is not an IP',
    );
});
...
test('ip returns true for IP values', (t) => {
    ...
    t.ok(
        is.ip('2001:0db8:85a3:0000:0000:8a2e:0370:7334'),
        '2001:0db8:85a3:0000:0000:8a2e:0370:7334 is an IP',
    );
    t.ok(
        is.ip('FE80:0000:0000:0000:0202:B3FF:FE1E:8329'),
        'FE80:0000:0000:0000:0202:B3FF:FE1E:8329 is an IP',
    );
});
...
test('not reverses all tests', (t) => {
    ...
    t.notOk(
        is.not.object({object: 'object'}),
        '{object:"object"} is not not an object',
    );
